...
public class NewWordActivity extends AppCompatActivity {
        ...
        add_field_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(!attribute_text.equals("") && !value_text.equals("")) {
                    ...
                    hashMap_fields.put(attribute_text.toLowerCase(), value_text);
                    attribute.setText("");
                    value.setText("");
                }
            }
        ...
        create_word.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(!word_name_text.equals("") && !word_meaning_text.equals("")) {
                    ...
                    hashMap_create.put("word", word_name_text.toLowerCase());
                    ...
                    reference.child("words").child(word_name_text).setValue(hashMap_create);
                    finish();
                }
            }
        });
    ...
    private void uploadImage(){
        final ProgressDialog pd = new ProgressDialog(NewWordActivity.this);
